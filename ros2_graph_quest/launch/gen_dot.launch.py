...
def generate_launch_description():
    ...
    declare_result_path = DeclareLaunchArgument('result_path', default_value=str(Path.home()/'test.dot'))
    ...
    declare_log_level = DeclareLaunchArgument("log_level", default_value=["INFO"], description="Logging level")
