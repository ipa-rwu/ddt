...
def generate_launch_description():
    ...
    declare_result_path = DeclareLaunchArgument('result_path', default_value=str(Path.home() / 'tmp' / 'lifecycle_parser'))
    ...
    graph_node = launch_ros.actions.Node(
            ...
            name='lifecycle_node_parser',
            executable='lifecycle_node_parser',
            parameters=[
